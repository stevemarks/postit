...
describe('ListPostitsComponent', () => {
  let component: ListPostitsComponent;
  let fixture: ComponentFixture<ListPostitsComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ListPostitsComponent);
